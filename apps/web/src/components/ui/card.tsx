...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-3xl border border-white/10 glass-card text-card-foreground shadow-2xl transition-all duration-300',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-xs text-muted-foreground mt-1.5 leading-relaxed', className)}
    {...props}
  />
));
